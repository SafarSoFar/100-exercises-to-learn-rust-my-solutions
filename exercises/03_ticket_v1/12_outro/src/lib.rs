...
impl Order{
    pub fn validate_product_name(product_name : &String){
        ...
        if product_name.len() > 300{
            panic!("Product anme cannot be more than 300 bytes");
        }
    }
    pub fn validate_quantity(quantity : &i32){
        if *quantity < 1{
            panic!("Quantity cannot be less than one");
        }
    }
    pub fn validate_unit_price(unit_price : &i32){
        if *unit_price < 1{
            panic!("Unit price cannot be less than one");
        }
    }
    //pub fn validate_quantity(quantity )
    ...
    pub fn set_unit_price(&mut self, new_unit_price : i32){
        ...
        self.unit_price = new_unit_price as u32;
    }
